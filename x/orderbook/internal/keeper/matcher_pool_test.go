...
func (i *MatchingPoolInput) PostOrders(t *testing.T, pool *MatcherPool) {
	...
	for id, input := range i.Markets {
		baseCurrency := ccstorage.Currency{Denom: input.BaseDenom, Decimals: input.BaseDecimals}
		quoteCurrency := ccstorage.Currency{Denom: input.QuoteDenom, Decimals: input.QuoteDecimals}
...
func TestOBKeeper_Matching_XARExample(t *testing.T) {
...
func TestOBKeeper_Matching_NotionExample(t *testing.T) {
...
func TestOBKeeper_Matching_ProRata(t *testing.T) {
	// Specific test.
...
func TestOBKeeper_Matching_FillPriority(t *testing.T) {
	// Specific test.
...
func TestOBKeeper_Matching_TwoOrders(t *testing.T) {
