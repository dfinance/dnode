...
func GetCmdPostOrder(cdc *codec.Codec) *cobra.Command {
	return &cobra.Command{
		...
		Example: "dncli orders post btc_dfi bid 100 100000000 1 --from wallet1a7280dyzp487r7wghr99f6r3h2h2z4gk4d740m",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msg := types.NewMsgPost(cliCtx.GetFromAddress(), assetCode, direction, price, quantity, ttlInSec)
