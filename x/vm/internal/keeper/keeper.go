...
func NewDeployReq(msg msgs.MsgDeployContract) vm.VMExecuteRequest {
...
func (keeper Keeper) DeployContract(ctx sdk.Context, msg msgs.MsgDeployContract) sdk.Error {
