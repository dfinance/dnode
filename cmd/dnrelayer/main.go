...
import (
	...
	"github.com/dfinance/dnode/cmd/dnrelayer/contract"
	"github.com/dfinance/dnode/cmd/dnrelayer/relayer"
	"github.com/dfinance/dnode/cmd/dnrelayer/txs"
)
...
func initRelayerCmd() *cobra.Command {
	...
	initRelayerCmd := &cobra.Command{
		...
		Example: "dnrelayer init tcp://localhost:26657 ws://localhost:7545/ 0x30753E4A8aad7F8597332E813735Def5dD395028 validator --chain-id=peggy",
