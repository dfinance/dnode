...
func main() {
    ...
    rootCmd.AddCommand(PrintGenesisCmd(ctx, cdc))
...
func PrintGenesisCmd(ctx *server.Context, cdc *codec.Codec) *cobra.Command {
    cmd := &cobra.Command{
        Use:    "genesis",
        Short:  "Print genesis config",
        Args:   cobra.NoArgs,
        RunE: func(_ *cobra.Command, _ []string) error {
            ...
            jsonBytes, _ := json.Marshal(genesis)
