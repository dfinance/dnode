...
Now let's add genesis account and initiate genesis PoA validators:
    ...
    wbd add-genesis-account [bank-address] 1000000000000000000000000wings
    wbd add-genesis-account [poa-address]  50000000000000000000000000wings
...
After run this command go to the directory `~/.wbd/config/gentx`, there is should be json file, like:
    ...
    "msg": [
      {
        ...
        "value": {
          ...
          "delegator_address": "wallets13nx3975ht32gkvn8qrvcejzpppwek7943hmr3k",
          "validator_address": "walletsvaloper13nx3975ht32gkvn8qrvcejzpppwek794au5mww",
          "pubkey": "walletsvalconspub1zcjduepqkmdx90jp0utwnne44rhdny280svfau2p6rvzwnte5kl8fa2nm2csk6je74",
          "value": {
            "denom": "stake",
    ...
    "signatures": [
      {
        "pub_key": {
          ...
          "value": "A6QR/fapv6nZUUQr1T3lvf8mPyxhQnF+PvZb8kr7jw2a"
        },
        "signature": "SPMICNl0VmM2eWkPA6ZQKcGhQUX5osvMwqGyCQeDof02ynrn9vishVziRpN4OGVaTfo2af/rsJ1b2bR7tQimjA=="
      }
    ],
    "memo": "554e63c14ac788991ee8a7bf098ca783f62d682b@192.168.129.7:26656"
  }
}
```

You have to change denom from `stake` autogenerated to `wings`:
